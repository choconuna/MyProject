...
class DealReservationFragment : Fragment() {

    private val TAG = DealReservationFragment::class.java.simpleName
    ...
    override fun onCreateView(
        ...
        val v : View? = inflater.inflate(R.layout.fragment_deal_reservation, container, false)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                try {
                    ...
                    for(dataModel in dataSnapshot.children) {
                        ...
                        if (item!!.state == "예약 중" && item!!.sellerId == myUid) { // 내가 판매 중인 데이터만
