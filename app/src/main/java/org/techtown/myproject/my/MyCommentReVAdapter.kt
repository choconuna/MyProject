...
import org.techtown.myproject.comment.*
import org.techtown.myproject.community.CommunityModel
import org.techtown.myproject.utils.FBRef

class MyCommentReVAdapter(val commentList : MutableList<CommentModel>) :
    RecyclerView.Adapter<MyCommentReVAdapter.CommentViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MyCommentReVAdapter.CommentViewHolder {
        val view =
            LayoutInflater.from(parent!!.context).inflate(R.layout.my_comment_list_item, parent, false)
        return CommentViewHolder(view)
    }

    override fun onBindViewHolder(holder: MyCommentReVAdapter.CommentViewHolder, position: Int) {
        ...
        val communityId = commentList[position].communityId
