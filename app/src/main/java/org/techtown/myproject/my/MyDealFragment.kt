...
class MyDealFragment : Fragment() {

    private val TAG = MyDealFragment::class.java.simpleName
    ...
    override fun onCreateView(
        ...
        val v : View? = inflater.inflate(R.layout.fragment_my_deal, container, false)
