...
class SearchFreeFragment : Fragment() {

    private val TAG = SearchFreeFragment::class.java.simpleName
    ...
    override fun onCreateView(
        ...
        val v : View? = inflater.inflate(R.layout.fragment_search_free, container, false)
                                ...
                                userNameRef.get().addOnSuccessListener {
                                    ...
                                    if(nickName.contains(searchText)) {
                                        if(date == "전체") { // 날짜가 전체일 경우
                                            ...
                                            Log.d("ninkName", communityMap.toString())
                                        } else { // 날짜가 일정 기간일 경우
                                            var nowDateSp = item!!.time.split(" ")
