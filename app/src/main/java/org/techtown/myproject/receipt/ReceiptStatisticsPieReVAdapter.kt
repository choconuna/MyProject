...
class ReceiptStatisticsPieReVAdapter(val receiptPieModel : ArrayList<ReceiptPieModel>):
    RecyclerView.Adapter<ReceiptStatisticsPieReVAdapter.ReceiptStatisticsPieViewHolder>() {
