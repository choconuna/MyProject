...
class MemoReVAdapter(val dogMemoList : ArrayList<DogMemoModel>):
    RecyclerView.Adapter<MemoReVAdapter.MemoViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MemoViewHolder, position: Int) {
        ...
        holder.memoDate!!.text = dogMemoList[position].date
