        ...
        writeBtn.setOnClickListener {
            ...
            when {
                ...
                content == "" -> {
                    ...
                    FBRef.dealRef.child(key).setValue(DealModel(key, myUid, pullLocationName, category, price, title, content, count.toString(), method, "판매 중", dateFormat, "", "", "0")) // 거래 정보 데이터베이스에 저장
