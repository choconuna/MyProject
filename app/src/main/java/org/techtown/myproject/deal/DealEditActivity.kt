        ...
        editBtn.setOnClickListener {
            ...
            when {
                ...
                content == "" -> {
                    ...
                    FBRef.dealRef.child(dealId).setValue(DealModel(dealId, myUid, locationArea.text.toString(), category, price, title, content, count.toString(), method, state, dateFormat)) // 거래 정보 수정
